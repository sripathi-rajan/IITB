...
const styles = StyleSheet.create({
  ...
  logoIconText: { color: '#0d9488', fontWeight: '800', fontSize: 15 },
  logoText: { fontSize: 22, fontWeight: '800', color: '#1c1917', letterSpacing: -0.5 },
  ...
  divider: { flex: 1, height: 1.5, backgroundColor: '#e7e5e4' },
  dividerText: { marginHorizontal: 14, color: '#78716c', fontSize: 13, fontWeight: '500' },
  ...
  input: { flex: 1, paddingVertical: 14, fontSize: 15, color: '#1c1917', fontWeight: '500' },
  fieldError: {
    color: '#dc2626',
    fontSize: 12,
    marginTop: -8,
  ...
  toggleText: { color: '#78716c', fontSize: 14 },
  toggleLink: { color: '#0d9488', fontSize: 14, fontWeight: '700' },
